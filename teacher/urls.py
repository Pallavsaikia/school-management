...
urlpatterns = [
    url(r'^(?P<id>\d+)?/?$', views.TeacherView.as_view(), name='teacher'),
    ...
    # url(r'subjects/(?P<courseid>\d+)/(?P<semester>\d+)/$', views.SemesterSubjectView.as_view(), name='subject'),
    # url(r'subjects/(?P<courseid>\d+)/(?P<semester>\d+)/(?P<subject>\d+)?/?$', views.SemesterSubjectView.as_view(), name='subject'),
